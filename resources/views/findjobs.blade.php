      ...
      <div class="row">
        <div class="col-sm-8">
          <div class="largeshowbox  text-left w3-white panel-default">
            <h5 class="panel-heading  panel-default">Việc làm ({{count($lst)}})</h5>
            @foreach($lst as $new)
            <div class="row">
            ...
            <div class="row ">
              <div class="col-sm-6">
                <ul class="pager w3-margin-top">
                  <li class="alert-warning" style="display: none;"><a href="#">Quay lại trang trước <i class="fa fa-angle-double-right"></i></a></li>
                </ul>
              </div>
              <div class="col-sm-6 ">
