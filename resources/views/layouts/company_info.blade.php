            ...
            <div class="col-sm-3">
                <div class="w3-card-2 w3-margin-bottom">
                    <div class="panel  panel-primary">
                        <div class="panel-heading"><b>Quản lý công ty</b></div>
                        <div class="panel-body">
                            <div class="w3-bar-block ">
                                <a href="{{route('thongtincongty',Auth::user()->id)}}" style="text-transform:capitalize;text-decoration: none;" class="w3-bar-item w3-button active">Thông tin công ty</a>
                                <a  href="{{route('thongtinlienhe',Auth::user()->id)}}" style="text-transform:capitalize;text-decoration: none;display: none;" class="w3-bar-item w3-button">Thông tin liên hệ</a>
                            </div>
                        </div>
                    </div>
                </div>
