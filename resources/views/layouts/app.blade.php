...
<body>
    ...
    <div class="modal fade" id="loginReFull" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content-dk modal-content">
                <div class="modal-header login_modal_header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    ...
                    <div class="modal-body login-modal">
                        ...
                        <div id='social-icons-conatainer'>
                            <div class='modal-body-register'>
                                ...
                                <div class="form-group">
                                    <select style="border-radius: 50px;" name="candidate">
                                        <center>
                                            <option selected value="0">Người ứng tuyển</option>
                                            <option value="1">Nhà tuyển dụng</option>
                                        </center>
                                ...
                                <center><button class="btn btn-success modal-login-btn" style="width: 200px;" type="submit">Đăng Ký</button></center>
