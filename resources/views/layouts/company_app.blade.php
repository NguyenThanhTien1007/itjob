            ...
            <nav>
                <div style="padding-left:80px">
                    <ul class="nav navbar-nav nav-stacked">
                        ...
                        <li><a href="{{route('thongtincongty',Auth::user()->id)}}" class="w3-hover-blue-gray active"> <span class="glyphicon glyphicon-user w3-margin-right"></span>Quản lý thông tin</a></li>
                        <li><a href="{{route('vieclamdangdang',Auth::user()->id)}}" class="w3-hover-blue-gray"><i class="fa fa-cubes w3-margin-right"></i>Quản lý đăng tuyển</a></li>
                        <li><a href="{{route('quanlyungtuyen',Auth::user()->id)}}" class="w3-hover-blue-gray active"> <span class="glyphicon glyphicon-user w3-margin-right"></span>Quản lý ứng tuyển</a></li>
                        <li style="display: none;"><a href="{{route('quanlytimkiemhoso')}}" class="w3-hover-blue-gray"><i class="fa fa-bell w3-margin-right"></i>Quản lý tìm kiếm hồ sơ</a></li>
                        <li><a href="{{route('change_password',Auth::user()->id)}}" class="w3-hover-blue-gray"><i class="fa fa-cog w3-margin-right"></i>Tài khoản </a></li>
            ...
            <div class="col-sm-3">
                <div class="w3-card-2 w3-margin-bottom">
                    <div class="panel  panel-primary">
                        <div class="panel-heading"><b>Quản Lý Đăng Tuyển</b></div>
                        <div class="panel-body">
                            <div class="w3-bar-block ">
                            <a href="{{route('vieclamdangdang',Auth::user()->id)}}" style="text-transform:capitalize;text-decoration: none;" class="w3-bar-item w3-button active">Việc Làm Đang Đăng ({{$countposting}})</a>
							<a href="{{route('vieclamchodang',Auth::user()->id)}}" style="text-transform:capitalize;text-decoration: none;" class="w3-bar-item w3-button">Việc Làm Chờ Đăng ({{$countwaitpost}})</a>
							<a href="{{route('vieclamtamdung',Auth::user()->id)}}" style="text-transform:capitalize;text-decoration: none;" class="w3-bar-item w3-button">Việc Làm Tạm Dừng Đăng ({{$countpausepost}})</a>
							<a href="{{route('vieclamhethan',Auth::user()->id)}}" style="text-transform:capitalize;text-decoration: none;" class="w3-bar-item w3-button">Việc Làm Hết Hạn ({{$countexpiredpost}})</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <header class="navbar-fixed-top">
        ...
        <nav id='cssmenu'>
            ...
            <ul style="float: right">
                ...
                <li><a href="{{route('findjobs')}}">Tìm việc làm</a>

                </li>

                <li><a href="{{route('postjob')}}">Đăng Việc</a></li>
                @if(Auth::check())
                ...
                <li class="w3-pink"> <a href='#'>Nhà tuyển dụng </a>
                    <ul>
                        <li class="w3-hover-brown"><a href="{{route('postjob')}}"><i class="glyphicon glyphicon-pencil  w3-margin-right"></i> Đăng tuyển</a></li>
                        <li class="w3-hover-brown"><a href="{{route('cvlist')}}"><i class="glyphicon glyphicon-search  w3-margin-right"></i> Tìm ứng viên</a></li>
