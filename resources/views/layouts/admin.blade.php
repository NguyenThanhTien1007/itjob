                ...
                <div class="w3-card-2 w3-margin-bottom">
                    <div class="panel  panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <a href="{{route('quanlycv')}}" style="text-transform:capitalize;text-decoration: none;" class="w3-bar-item w3-button active">Quản Lý Hồ Sơ</a>
							<a href="{{route('quanlyvieclam')}}" style="text-transform:capitalize;text-decoration: none;" class="w3-bar-item w3-button">Quản Lý Việc Làm </a>
							<a href="{{route('quanlytaikhoan')}}" style="text-transform:capitalize;text-decoration: none;" class="w3-bar-item w3-button">Quản Lý Tài Khoản </a>
